 ...
 */
public class BlockSFM extends BlockContainer
{
    public boolean updateInventorys;
    ...
    public void setUpdateInventorys(boolean value)
    {
        this.updateInventorys = value;
    }

    public boolean update()
    {
        return this.updateInventorys;
    }
